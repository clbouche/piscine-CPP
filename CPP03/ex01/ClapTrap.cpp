...
/*   Updated: 2022/02/02 11:53:25 by clbouche         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	std::cout << BLUE1 << "Name contructor called - ClapTrap" << END << std::endl;
	return ;
}

ClapTrap::ClapTrap(void) : _name("CLAPTRAP"), _hitPoints(10), _energyPoints(10), _attackDamage(0)
{
	std::cout << BLUE1 << "Default constructor called - ClapTrap" << END << std::endl;
	return ;
}
...
ClapTrap::~ClapTrap()
{
	std::cout << BLUE1 << "Destructor called - ClapTrap" << END << std::endl;
	return ;
}